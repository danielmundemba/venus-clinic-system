...
const AuditLogs = () => {
  ...
  const getActionDot = (action) => {
    const colors = {
      ...
      DELETE: "bg-red-400",
      VIEW: "bg-sky-400",
      LOGIN: "bg-venus-primary-400",
      EXPORT: "bg-sky-400",
      SCHEDULE: "bg-venus-primary-400",
  ...
  const getStats = () => {
    ...
    return [
      ...
      },
      {
        ...
        trend:
          logs.length > 0
            ? ((todayLogs.length / logs.length) * 100).toFixed(1)
            : 0,
    ...
    <div className="card hover:bg-venus-bg-elevated transition-all duration-200">
      <div className="flex items-start justify-between">
        <div>
          ...
          {trend !== undefined && (
            <p
              className={`text-sm mt-2 flex items-center gap-1 ${trend >= 0 ? "text-emerald-400" : "text-red-400"}`}
            >
  ...
  const renderDetails = (details) => {
    if (!details || Object.keys(details).length === 0) {
      return (
        <p className="text-sm text-venus-text-muted italic">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {Object.entries(details).map(([key, value]) => {
          ...
          return (
            <div
              key={key}
              className="bg-white dark:bg-gray-800/50 rounded-lg p-3 border border-venus-border hover:border-venus-primary-500/30 transition-colors"
            >
              <div className="flex items-start gap-2.5">
                <div className="p-1.5 rounded-md bg-venus-primary-500/10 text-venus-primary-400 shrink-0 mt-0.5">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p
                    className={`text-sm font-medium text-venus-text-primary break-all ${isLongValue ? "text-xs" : ""}`}
                  >
                    {displayValue}
                  </p>
                </div>
                      ...
                      <React.Fragment key={log.id}>
                        ...
                        >
                          <td className="py-3 px-4">
                            <div className="flex items-center gap-3">
                              <div
                                className={`p-2 rounded-lg border ${getActionColor(log.action)}`}
                              >
                              ...
                              <div>
                                ...
                                <div className="flex items-center gap-1.5 mt-0.5">
                                  <span
                                    className={`w-1.5 h-1.5 rounded-full ${getActionDot(log.action)}`}
                                  ></span>
                          ...
                          <td className="py-3 px-4">
                            <div className="flex items-center gap-3">
                              <div className="w-9 h-9 rounded-full bg-venus-primary-500/20 flex items-center justify-center text-venus-primary-400 text-xs font-bold">
                        ...
                        {isExpanded && (
                          <tr>
                            <td
                              colSpan={5}
                              className="px-4 py-5 bg-venus-bg-tertiary/40"
                            >
                              <div className="space-y-5">
                                {/* Action Summary */}
                                <div className="flex items-center gap-3 pb-4 border-b border-venus-border/50">
                                  <div
                                    className={`p-2.5 rounded-xl border ${getActionColor(log.action)}`}
                                  >
                                  ...
                                  <div>
                                    ...
                                    <p className="text-sm text-venus-text-muted">
                                      {formatTimestamp(log.timestamp)} by{" "}
                                      {userDisplay.name}
                                    </p>
                                  </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                                  ...
                                  <div className="bg-white dark:bg-gray-800/30 rounded-xl p-4 border border-venus-border">
                                    <h4 className="text-sm font-semibold text-venus-text-primary flex items-center gap-2 mb-4">
                                      <div className="p-1.5 rounded-md bg-venus-primary-500/10">
                                    ...
                                    <div className="space-y-3">
                                      ...
                                      <div className="flex items-center justify-between">
                                        ...
                                        <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-venus-primary-500/10 text-venus-primary-400 capitalize">
                                          {userDisplay.role}
                                        </span>
                                      </div>
                                      <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-xs font-mono text-venus-text-primary bg-venus-bg-tertiary px-2 py-1 rounded">
                                          {log.userId}
                                        </span>
                                      </div>
                                    </div>
                                  ...
                                  <div className="bg-white dark:bg-gray-800/30 rounded-xl p-4 border border-venus-border">
                                    ...
                                    <div className="space-y-3">
                                      <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-sm font-medium text-venus-text-primary capitalize">
                                          {log.resourceType || "N/A"}
                                        </span>
                                      </div>
                                      <div className="flex items-center justify-between">
                                      ...
                                      <div className="flex items-center justify-between">
                                        ...
                                        <span
                                          className={`px-2 py-0.5 rounded-lg text-xs font-medium border ${getActionColor(log.action)}`}
                                        >
                                          {log.action}
                                        </span>
                                      </div>
