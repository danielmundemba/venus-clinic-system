...
const MedicalRecordDetails = () => {
  ...
  // Receptionists can see the whole record (reception → billing) even
  // though they can only *edit* the reception and billing stages.
  const canViewStageForRole = (role, stage) => {
    const viewMatrix = {
      receptionist: ["reception", "nurse", "doctor", "pharmacy", "billing"],
                      ...
                      >
                        ...
                        {lowStock && (
                          <p className="text-xs text-red-400 flex items-center gap-1">
                            ...
                            {med.stock} in stock — pharmacist will need to
                            adjust
                          </p>
                        )}
                        <button
        ...
        >
          ...
          {isStageSkipped("pharmacy") ? (
            <p className="text-venus-text-muted text-sm italic flex items-center gap-2">
              <Minus className="w-4 h-4" />
              Skipped — the doctor marked this visit as not requiring
              medication.
            </p>
