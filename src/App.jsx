...
const MedicalRecordsList = lazy(
  () => import("./pages/medical-records/MedicalRecordsList"),
);
const CreateMedicalRecord = lazy(
  () => import("./pages/medical-records/CreateMedicalRecord"),
);
const MedicalRecordDetails = lazy(
  () => import("./pages/medical-records/MedicalRecordDetails"),
);
...
const RoleAwareRedirect = () => {
  ...
  return (
    <Navigate
      to={userRole === "patient" ? "/my-health" : "/dashboard"}
      replace
    />
  );
};
        ...
        <Router>
          <Routes>
            ...
            >
              ...
              />
              <Route
                path="/medical-records/:patientId/:recordId"
                element={
                  <ProtectedRoute
                    allowedRoles={[
                      "admin",
