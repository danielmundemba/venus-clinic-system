      ...
      <div className="space-y-2">
        <div className="grid grid-cols-7 gap-1">
          {weekDays.map((day) => (
            <div
              key={day}
              className="text-center text-sm font-medium text-venus-text-muted py-2"
            >
              {day}
            </div>
          ))}
              ...
              >
                ...
                <div className="mt-2 space-y-1">
                  {dayApps.slice(0, 2).map((app, i) => (
                    <div
                      key={i}
                      className="text-xs text-venus-text-muted truncate"
                    >
                      {app.time} {app.patientName || "Patient"}
                    </div>
                  ))}
          ...
          <div className="grid grid-cols-[80px_1fr] divide-x divide-venus-border">
            <div className="bg-venus-bg-tertiary">
              {timeSlots.map((slot, i) => (
                <div
                  key={i}
                  className="h-12 flex items-center justify-center text-xs text-venus-text-muted border-b border-venus-border/30"
                >
                  {slot}
                </div>
              ))}
                ...
                return dayApps.map((app, appIndex) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-venus-text-muted truncate">
                        {app.time}
                      </div>
                    </div>
                  );
            ...
            {dayApps.map((app, index) => {
              ...
              return (
                ...
                >
                  ...
                  {app.notes && (
                    <p className="mt-1 text-xs text-venus-text-muted truncate">
                      {app.notes}
                    </p>
                  )}
                </div>
